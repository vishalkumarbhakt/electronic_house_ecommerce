"""
Django settings for electronic_house project.
...
WSGI_APPLICATION = 'electronic_house.wsgi.application'
...
if os.getenv('EMAIL_HOST'):
    ...
    EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@electronichouse.in')
